...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/UserCode/TTbarMETIPHC/Alex/ProdConfig/writeCMSSWConfig_data.py,v $'),
...
options.register('mcInfo', False, VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.int, "process MonteCarlo data") # False for data
...
options.register ('useData', True, VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.bool, 'Run this on real data')
...
# ---------------------- General info -------------------------------
        ...
        isData              = cms.bool(True),    # Monte-Carlo files
# ----------------------   Trigger    -------------------------------
...
# run Arecover
#process.GlobalTag.globaltag = cms.string('FT_R_53_V6C::All')
# run C1
#process.GlobalTag.globaltag = cms.string('FT_R_53_V10::All')
# run C2
#process.GlobalTag.globaltag = cms.string('GR_P_V41::All')
# run D
process.GlobalTag.globaltag = cms.string('GR_P_V42::All')
